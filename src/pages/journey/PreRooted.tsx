...
const AccordionCard = ({ point }: { point: typeof compassPoints[0] }) => {
  ...
  return (
    <div className="rounded-xl border overflow-hidden" style={{ borderColor: "rgba(188,173,212,0.5)", backgroundColor: "#fff" }}>
      ...
      >
        <div>
          <p className="font-bold text-base" style={{ color: "#1A1A1A" }}>{point.title}</p>
          <p className="text-sm mt-0.5 italic" style={{ color: "#6B6B6B" }}>{point.question}</p>
        </div>
        <ChevronDown
          size={20}
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div className="px-5 pb-5 text-sm leading-[1.8] whitespace-pre-line" style={{ color: "#1A1A1A" }}>
              {point.content}
            </div>
          </motion.div>
        )}
  ...
  >
    ...
    <Section className="py-20" bg="#FAF9F6">
      <div className="container mx-auto max-w-3xl">
        ...
        <p className="text-base mb-8" style={{ color: "#6B6B6B" }}>5 questions to ask before you move abroad</p>
    ...
    <Section className="py-20" bg="#F3F0F7">
      <div className="container mx-auto max-w-3xl">
        <h2 className="font-extrabold text-2xl md:text-3xl leading-tight mb-2" style={{ color: "#1A1A1A", fontWeight: 800 }}>
          The Four Directions
        </h2>
        <p className="text-base mb-8" style={{ color: "#6B6B6B" }}>
