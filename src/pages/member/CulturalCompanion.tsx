  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground mt-4 text-center">
        Tips are generated by AI based on publicly available cultural knowledge. They reflect general tendencies, not universal truths, and may not match every individual's experience. For questions or concerns, contact us at <a href="mailto:hello@rerooted.com" className="underline hover:text-foreground">hello@rerooted.com</a>
      </p>
      </div>
    </motion.div>
  );
