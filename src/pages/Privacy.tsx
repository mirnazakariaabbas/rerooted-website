  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-3">To exercise any of these rights, please contact us at: hello@re-rooted.com</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="mt-2 list-disc pl-6 space-y-2">
          <li>Parents or legal guardians may request access to, correction of, or deletion of their children's data at any time by contacting us at hello@re-rooted.com.</li>
        ...
        <p className="mt-3">If you believe that data about a child has been collected without proper parental consent, please contact us immediately at hello@re-rooted.com and we will take prompt action to investigate and delete the data if appropriate.</p>
      </>
    ),
  },
  {
