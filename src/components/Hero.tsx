  ...
  return (
    <section className="relative flex min-h-screen items-center bg-background">
      <div className="container mx-auto flex max-w-6xl flex-col items-center gap-12 px-6 py-12 md:flex-row md:items-center md:gap-8 md:px-12 md:py-10 2xl:max-w-[1280px]">
        ...
        <motion.div
          className="flex w-full items-center justify-center overflow-visible md:basis-[55%] md:flex-none md:justify-end"
        ...
        >
          <img
            ...
            className="h-auto max-h-[70vh] w-auto max-w-[640px] object-contain sm:max-w-[760px] md:max-h-[72vh] md:max-w-none md:translate-x-[8%]"
            loading="eager"
            fetchPriority="high"
            decoding="async"
            width={1600}
