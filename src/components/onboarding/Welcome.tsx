...
const Welcome = ({ onNext }: WelcomeProps) => (
  <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
    ...
    <h1 className="text-3xl md:text-4xl font-serif leading-tight mb-6 text-foreground">
    ...
    <Button onClick={onNext} size="lg" className="rounded-full px-10 py-6 text-base font-medium shadow-lg">
      Let's get started
    </Button>
