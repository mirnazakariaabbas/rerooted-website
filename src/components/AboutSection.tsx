...
const AboutSection = () => {
  ...
  return (
    <section id="about" className={`px-6 lg:px-12 ${isIndividual ? "py-32" : "py-28"}`} style={{ background: "#1C4339" }}>
      <div className="max-w-6xl mx-auto">
        {/* Top-left section eyebrow header — aligned with previous section */}
        <p className="text-[11px] font-semibold uppercase tracking-[0.22em] mb-16 md:mb-20" style={{ color: "#2C6A58" }}>
        ...
        >
          <h2 className="font-extrabold text-3xl md:text-[40px] leading-tight mb-6" style={{ color: "#F5F2EA" }}>
            {isIndividual ? (
              <>
                I've been where
                <br />
